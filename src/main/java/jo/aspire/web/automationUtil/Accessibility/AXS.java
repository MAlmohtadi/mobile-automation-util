...
public class AXS {
	 ...
	 */
	public AXS(final WebDriver driver, final URL script) {
		this.driver = driver;
		this.script = script;

		AXS.inject(this.driver, this.script);
	}
...
//	}
	...
	public String verify() {
		String results = String.format("var results = axs.Audit.run(); return axs.Audit.createReport(results); ");
		return execute(results);
	}
