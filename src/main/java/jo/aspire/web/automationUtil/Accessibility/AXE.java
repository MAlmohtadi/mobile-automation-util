...
public class AXE {
	...
	public static class Builder {
		 ...
		 * @param driver An initialized WebDriver
		 * @param script The path of aXe library: https://github.com/dequelabs/axe-core
		 * 
		 */
		...
		/**
		 * get the violation array : 
		 * JSONArray violations = analyze().getJSONArray("violations");
		 * 
		 * to assert the violation:
		 * if (violations.length() == 0) {
		 *	assertTrue("No violations found", true);
		 *} else {			
		 *	assertEquals("", AXE.report(violations));
		 *}
		 */
